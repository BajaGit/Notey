...
public final class Projections {
	...
	public static <Type extends DocumentProjection> List<Type> all(Database database, Class<Type> type){
		return Projections.byKeys(database, type, null);
	}
	...
	public static <Type extends DocumentProjection> List<Type> byKey(Database database, Class<Type> type, Object key){
		...
		keys.add(key);
		return Projections.byKeys(database, type, keys);
	}
	
	public static <Type extends DocumentProjection> List<Type> byKeys(Database database, Class<Type> type, Vector<Object> keys){
